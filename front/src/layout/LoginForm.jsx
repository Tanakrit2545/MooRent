...
export default function LoginForm() {
  ...
  return (
    <div className="background-container relative flex items-center justify-center h-screen"> 
      <div className="language-switch absolute top-0 left-60 mt-10 mr-10">
        ...
        <div className="logo mt-300  " />
      </div>
      <div className="login-logo mb-5">
    <div className="logo-text">MotorRent</div> {/* Add MotorRent text */}
</div> 

    
      <div className="cart-support-container absolute top-0 right-0 mt-10 mr-10 flex"> {/* Container for cart and support buttons */}
        <div className="cart-button mr-4">
          <button className="btn btn-cart">
            Cart
          </button>
        </div>

        <div className="support-button"> {/* Add support button */}
          <button className="btn btn-support" style={{backgroundColor: '#FF0000', color: '#FFFFFF'}}> {/* Apply inline styles */}
            Support
          </button>
        </div>
      </div>
